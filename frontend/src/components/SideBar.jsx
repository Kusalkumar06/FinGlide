  ...
  return (
    <div className="w-full ">
      <div className='flex w-full'>
        <div className='border-r-1 min-w-74 h-screen bg-gradient-to-b from-orange-100 via-white to-orange-100 flex flex-col sticky top-0 left-0 z-50'>
          <div className='flex items-center gap-2 p-5 px-3'>
            <div className='rounded-[50%] p-1 bg-[#da6e39] mr-1'>
              <img className='w-[55px] h-[55px] shrink-0 object-contain' src='https://res.cloudinary.com/dtrouncfb/image/upload/v1756573796/LogoMakr-0It9qV_n5txbu.png'/>
            </div>
            <div className='flex flex-col justify-center leading-tight whitespace-nowrap gap-2'>
              <img className='w-[110px] h-auto shrink-0 object-contain' src='https://res.cloudinary.com/dtrouncfb/image/upload/v1756719245/LogoMakr-44Pg4a_qp9nad.png'/>
